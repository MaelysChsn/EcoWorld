...
IL2CPP_EXTERN_C const uint32_t JsonUtility_FromJson_m81FC2A7DCB9231E8E201EAD8E160F921B1D2E25C_MetadataUsageId;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR RuntimeObject * JsonUtility_FromJson_m81FC2A7DCB9231E8E201EAD8E160F921B1D2E25C (String_t* ___json0, Type_t * ___type1, const RuntimeMethod* method)
{
	...
	{
		il2cpp_codegen_initialize_method (JsonUtility_FromJson_m81FC2A7DCB9231E8E201EAD8E160F921B1D2E25C_MetadataUsageId);
...
IL_000f:
	...
	}
	{
		...
		ArgumentNullException__ctor_m81AB157B93BFE2FBFDB08B88F84B444293042F97(L_5, _stringLiteralF3C6C902DBF80139640F6554F0C3392016A8ADF7, /*hidden argument*/NULL);
		IL2CPP_RAISE_MANAGED_EXCEPTION(L_5, JsonUtility_FromJson_m81FC2A7DCB9231E8E201EAD8E160F921B1D2E25C_RuntimeMethod_var);
	}
...
IL_0022:
	{
		Type_t * L_6 = ___type1;
		NullCheck(L_6);
		bool L_7 = Type_get_IsAbstract_mB16DB56FCABF55740019D32C5286F38E30CAA19F(L_6, /*hidden argument*/NULL);
		if (L_7)
		{
			goto IL_003c;
		}
	}
	{
		...
		NullCheck(L_8);
		bool L_11 = VirtFuncInvoker1< bool, Type_t * >::Invoke(110 /* System.Boolean System.Type::IsSubclassOf(System.Type) */, L_8, L_10);
		G_B7_0 = ((int32_t)(L_11));
		goto IL_003d;
	}
...
IL_003d:
	...
	}
	{
		...
		String_t* L_15 = String_Concat_m89EAB4C6A96B0E5C3F87300D6BE78D386B9EFC44(_stringLiteral9149DCC4875937380DD00ED5471A7A1258254B95, L_14, _stringLiteral1A021298794A95A088D89F0DFEE478EB088FC94B, /*hidden argument*/NULL);
		ArgumentException_t505FA8C11E883F2D96C797AD9D396490794DEE00 * L_16 = (ArgumentException_t505FA8C11E883F2D96C797AD9D396490794DEE00 *)il2cpp_codegen_object_new(ArgumentException_t505FA8C11E883F2D96C797AD9D396490794DEE00_il2cpp_TypeInfo_var);
		ArgumentException__ctor_m2D35EAD113C2ADC99EB17B940A2097A93FD23EFC(L_16, L_15, /*hidden argument*/NULL);
		IL2CPP_RAISE_MANAGED_EXCEPTION(L_16, JsonUtility_FromJson_m81FC2A7DCB9231E8E201EAD8E160F921B1D2E25C_RuntimeMethod_var);
	}
...
IL_005c:
	{
		...
		RuntimeObject * L_19 = JsonUtility_FromJsonInternal_m7353836E98A52C702E713DBE5E9C431BD8EC830A(L_17, NULL, L_18, /*hidden argument*/NULL);
		V_1 = L_19;
		goto IL_0067;
	}
